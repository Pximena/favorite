...
public class FavoriteAdapter extends  RecyclerView.Adapter<FavoriteAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        holder.textViewid_fav.setText(String.valueOf(favoriteList.get(position).getId_fav()));
        holder.textViewid_user.setText(String.valueOf(favoriteList.get(position).getId_user()));
        holder.textViewid_prod.setText(String.valueOf(favoriteList.get(position).getId_prod()));
